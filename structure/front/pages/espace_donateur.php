  ...
  <div class="row">
    ...
    <div class="col-md-6 col-sm-6 col-lg-6">
      <form method="POST"> <!-- Ajout de l'attribut method pour envoyer le formulaire en POST -->
        ...
        <p class="inscription">Vous n'avez pas de compte ? <a href="/inscription">Inscrivez-vous</a></p>
         <!-- Lien vers mot de passe oublié -->
         <p class="monPasse"><a href="/forgot_password.php">Mot de passe oublié ?</a></p>
    </div>
    <div class="col-md-3 col-sm-3 col-lg-3"></div>
  </div>
</section>
